...
export default function ContactPopup({
  ...
  const waMessage = packageName
    ? encodeURIComponent(
        `Hello, I am interested in the *${packageName}* package from Kaluna Technology. Could you assist me?`
      )
    : encodeURIComponent(
      ...
      >
        ...
        >
          ...
          <div className="px-7 pb-8 pt-6">
            ...
            >
              {packageName ? `${packageName} Package` : "Contact Us"}
            </h2>
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-[15px] font-semibold leading-none text-[#0D2342]">
                    Start a Consultation
                  </p>

                  <p className="mt-1 text-[12px] leading-relaxed text-[#64748B]">
                    Complete our consultation form, and our team will contact
                    you shortly.
                  </p>
                </div>

                <svg
                  className="h-4 w-4 shrink-0 text-[#94A3B8] transition-transform duration-200 group-hover:translate-x-0.5 group-hover:text-[#299EED]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
              ...
              >
                ...
                <svg
                  className="h-4 w-4 shrink-0 text-[#94A3B8] transition-transform duration-200 group-hover:translate-x-0.5 group-hover:text-[#25D366]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
