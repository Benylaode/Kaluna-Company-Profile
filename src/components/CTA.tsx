  ...
  return (
    <section className="max-w-7xl mx-auto px-10 pb-5">
      <div className="relative w-full bg-[#0D2342] rounded-3xl p-8 md:p-14 overflow-hidden flex flex-col md:flex-row md:items-center md:justify-between gap-8 shadow-lg">
        ...
        {/* Ornamen Geometris Latar Belakang (Mendekati image_51f19d.png) */}
    ...
    <div className="relative z-10 flex-shrink-0">
      <button
        ...
        className="inline-flex items-center gap-4 bg-white hover:bg-gray-100 text-[#0D2342] font-semibold px-6 py-4 rounded-full shadow-md transition-all group"
      >
