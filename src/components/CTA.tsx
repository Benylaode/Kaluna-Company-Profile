  ...
  return (
    <section className="bg-[#FAFAFA] pb-12 md:pb-3 lg:pb-3 w-full">
      <div className="kaluna-wide-container">
        <div className="relative flex flex-col justify-between gap-8 overflow-hidden rounded-[24px] bg-[#0E2A54] px-6 py-8 md:flex-row md:items-center md:px-10 md:py-10 lg:px-12 lg:py-12">
          {/* Background Patterns */}
