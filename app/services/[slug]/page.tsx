  ...
  return (
    <main className="min-h-screen bg-white font-sans text-[#0D2342] overflow-x-hidden">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed right-4 md:right-6 top-1/2 -translate-y-1/2 z-50 w-12 h-12 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
      >
