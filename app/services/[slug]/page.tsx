  ...
  return (
    <main className="min-h-screen bg-white font-sans text-[#0D2342] overflow-x-hidden">
      ...
      <section className="w-full bg-white pt-[80px] sm:pt-[110px] md:pt-[90px] pb-2 md:pb-4">
        ...
        <div className="mx-auto max-w-[1440px] px-[clamp(16px,4vw,60px)] mb-4 md:mb-5">
      ...
      <section className="w-full bg-white">
        <div className="mx-auto max-w-[1440px] px-[clamp(16px,4vw,60px)] pt-10 pb-12 md:pt-12 md:pb-16 lg:pt-[44px] lg:pb-[60px]">
      ...
      <section
        ...
        "
      >
        <div className="mx-auto max-w-[1440px] w-full px-[clamp(16px,4vw,60px)]">
          {/* Section label */}
      ...
      <section className="w-full bg-white py-6 lg:py-[28px]">
        <div className="kaluna-wide-container">
          <div
            ...
            "
          >
            <div className="mx-auto max-w-[1440px] px-[clamp(16px,4vw,60px)]">
              {/* Label */}
