...
import ServicePackageCard from "@/src/components/ServicePackageCard";
  ...
  return (
    <main className="min-h-screen bg-white font-sans text-[#0D2342] overflow-x-hidden">
      ...
      <section className="w-full bg-white">
        <div className="kaluna-container px-[clamp(20px,5vw,72px)] pt-10 pb-12 md:pt-12 md:pb-16 lg:pt-[44px] lg:pb-[60px]">
      ...
      <OurProcese steps={serviceData.processes} />
